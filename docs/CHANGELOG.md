...
- 2026-09-06 — Live latest-session fix: numeric resolution, session-start anchoring, intervals coverage flag — see `changes/2026-09-06-live-latest-session-fix.md`.
